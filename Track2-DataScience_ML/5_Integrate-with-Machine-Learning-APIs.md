...
*lab Link* (GSP329): https://google.qwiklabs.com/focuses/12704?parent=catalog

**Task 1: Configure a service account to access the Machine Learning APIs, BigQuery, and Cloud Storage** `AND` **Task 2: Create and download a credential file for your Service Account**

> Go to **Cloud Shell** `Run the following codes`
...
> Already Done with the above code
